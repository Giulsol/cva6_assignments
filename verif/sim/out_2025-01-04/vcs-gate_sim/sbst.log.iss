...
[fdb_start] Started server po.polito.it:50272 pid=9839 fdb_path /home/s324967/TESTING_LABS/project/cva6_assignments/verif/sim/fdb
Info: Connected to started server
Loading design information...
Done (CPU time: 0s, elapsed time: 0s, memory increased by 71Mb, peak: 92Mb).
...
Generating faults...
Done (64688 faults generated, CPU time: 0s, elapsed time: 1s, memory increased by 37Mb, peak: 132Mb).
Collecting design strobes...
Done (CPU time: 0s, elapsed time: 0s, memory increased by 1Mb, peak: 134Mb).
Loading design details...
Done (CPU time: 3s, elapsed time: 6s, memory increased by 262Mb, peak: 396Mb).
Constant propagation...
Done (CPU time: 1s, elapsed time: 3s, memory increased by 8Mb, peak: 405Mb).
Static testability analysis...
Done (CPU time: 0s, elapsed time: 1s, memory increased by 2Mb, peak: 407Mb).
Reconvergence check...
Done (CPU time: 0s, elapsed time: 0s, memory increased by 0Mb, peak: 407Mb).
Pruning...
Done (CPU time: 1s, elapsed time: 2s, memory increased by 4Mb, peak: 411Mb).
Collapsing...
Done (CPU time: 3s, elapsed time: 8s, memory increased by 39Mb, peak: 450Mb).
Preparing to write to FDB...
Done (CPU time: 0s, elapsed time: 1s, memory increased by 2Mb, peak: 452Mb).
Writing fault campaign to FDB...
Done (CPU time: 1s, elapsed time: 1s, memory increased by 14Mb, peak: 466Mb).
Total faults generated: 64688.
Collapsed faults:       30123.
Untestable faults:      144.
Fault reduction:        46%.
1 warning
CPU time: 13s, elapsed time: 84s, peak memory: 466MB.
...
po.polito.it:50272 (cva6) vc_fcm> set_config -global_max_jobs 1 
po.polito.it:50272 (cva6) vc_fcm> ### Create test campaign based on UVM testbench and runtime-compiled ELF binary
po.polito.it:50272 (cva6) vc_fcm> ## DYNAMIC RUNTIME
po.polito.it:50272 (cva6) vc_fcm> create_testcases -name {"test1"} \
po.polito.it:50272 (cva6) vc_fcm>     -exec ${::env(VCS_WORK_DIR)}/simv \
po.polito.it:50272 (cva6) vc_fcm>     -args "-sv_lib ${::env(SPIKE_INSTALL_DIR)}/lib/libriscv \
po.polito.it:50272 (cva6) vc_fcm> 	-sv_lib ${::env(SPIKE_INSTALL_DIR)}/lib/libfesvr \
po.polito.it:50272 (cva6) vc_fcm> 	${::env(ALL_SIMV_UVM_FLAGS)} \
po.polito.it:50272 (cva6) vc_fcm> 	++${::env(elf)} \
po.polito.it:50272 (cva6) vc_fcm> 	+elf_file=${::env(elf)} \
po.polito.it:50272 (cva6) vc_fcm> 	+tohost_addr=${::env(to_host_address)} \
po.polito.it:50272 (cva6) vc_fcm> 	${::env(cov-run-opt)} ${::env(issrun_opts)}"
po.polito.it:50272 (cva6) vc_fcm> ### Start fault simulation
po.polito.it:50272 (cva6) vc_fcm> fsim -verbose
------------------------------------------------------------------------
...
Check progress of tasks by their output files stored in /home/s324967/TESTING_LABS/project/cva6_assignments/verif/sim/fcm.dir/session0001_2025-01-04-17:04:10_po.polito.it_PID17262/tasks/*/out.log
and by section 1 in /home/s324967/TESTING_LABS/project/cva6_assignments/verif/sim/fcm.dir/session0001_2025-01-04-17:04:10_po.polito.it_PID17262/tasks/summary.csv

  Time  | Workers |     Tasks        |  Time   Mem | results from completed task(s)
        |act./req.|active    done    |   [s]   [MB]|                               
--------+---------+------------------+-------------+-------------------------------
17:04:12|   -/   1|    2     - (  0%)|     -      -|<START>
17:04:13|   1/   1|    2     0 (  0%)|             |Worker1 started on host po.polito.it
17:04:13|   1/   1|    2     0 (  0%)|             |Task1(test1) started on worker1
17:05:47|   1/   1|    2     0 (  0%)|             |Task2(test1) started on worker1
17:05:47|   1/   1|    1     1 ( 50%)|    94    622|Task1(tsim,test1) done
17:06:12|   0/   0|    0     2 (100%)|    24    484|Task2(coats,test1) done, NC:2164 NO:20696 
17:06:12|   -/   -|    -     2 (100%)|     -      -|<FINISH>
...
--------+---------+---------------------------------+-------------+-------------------------------
17:06:15|   -/   1|    9515     2046        0 (  0%)|     -      -|<START>
17:06:16|   1/   1|    9515     2046        0 (  0%)|             |Worker1 started on host po.polito.it
17:06:16|   1/   1|    9515     2046        0 (  0%)|             |Task3(test1) started on worker1
17:11:05|   1/   1|    7469     2046     2046 ( 17%)|   289    982|Task3(test1) done, 2046, NN:347 ON:1699
17:11:06|   1/   1|    7469     2046     2046 ( 17%)|             |Task4(test1) started on worker1
17:15:00|   1/   1|    5423     2046     4092 ( 35%)|   235    983|Task4(test1) done, 2046, NN:540 ON:1506
17:15:01|   1/   1|    5423     2046     4092 ( 35%)|             |Task5(test1) started on worker1
17:19:25|   1/   1|    3377     2046     6138 ( 53%)|   264   1007|Task5(test1) done, 2046, NN:230 ON:1816
17:19:26|   1/   1|    3377     2046     6138 ( 53%)|             |Task6(test1) started on worker1
17:23:42|   1/   1|    1331     2046     8184 ( 70%)|   256    957|Task6(test1) done, 2046, NN:67 ON:1979
17:23:43|   1/   1|    1331     2046     8184 ( 70%)|             |Task7(test1) started on worker1
17:27:50|   1/   1|       0     1331    10230 ( 88%)|   248    992|Task7(test1) done, 2046, NN:67 ON:1979
17:27:51|   1/   1|       0     1331    10230 ( 88%)|             |Task8(test1) started on worker1
17:31:59|   0/   0|       0        0    11561 (100%)|   249   1121|Task8(test1) done, 1331, NN:54 ON:1277
17:31:59|   -/   -|       -        -    11561 (100%)|     -      -|<FINISH> total results: 11561
...
Fault Gen   (  0%) |                  - |           - |       - |      - |      -
===================+====================+=============+=========+========+=======
Combined    (  7%) |           00:02:00 |         117 |      51 |    622 |    999
-------------------+--------------------+-------------+---------+--------+-------
Toggle Sim         |                  - |          94 |      42 |    622 |    999
  setup            |       po.polito.it |           0 |       - |      - |      -
  Total Queued     |                  - |           0 |       - |      - |      -
  test1            |       po.polito.it |          94 |      42 |    622 |    999
-------------------+--------------------+-------------+---------+--------+-------
Testability        |                  - |          23 |       9 |    484 |      -
  test1            |       po.polito.it |          23 |       9 |    484 |      -
===================+====================+=============+=========+========+=======
Fault Sim   ( 93%) |           00:25:47 |        1539 |     851 |   1121 |   1476
  setup (FDB)      |       po.polito.it |           3 |       - |      - |      -
  Total Queued     |                  - |           0 |       - |      - |      -
  test1            |             6 jobs |        1536 |     851 |   1121 |   1476
===================+====================+=============+=========+========+=======
Total       (100%) |           00:27:47 |        1656 |     902 |   1121 |   1476
=================================================================================

po.polito.it:50272 (cva6) vc_fcm> ### Write results' report
po.polito.it:50272 (cva6) vc_fcm> report -campaign cva6 -report fsim_v.rpt -overwrite
starting VC FDB Reporting

will invoke: "/opt/synopsys/vcs/W-2024.09-SP1/bin/vc_fdb_report  -report 'fsim_v.rpt' -overwrite -campaign cva6 -xhidden "nobanner" -fdb_path /home/s324967/TESTING_LABS/project/cva6_assignments/verif/sim/fdb -fdb_project default 2>&1"
...
Info:	Wrote Standard Fault Format report to fsim_v.rpt
...
CPU time: 33s, elapsed time: 1673s, peak memory: 99MB.
make[2]: Leaving directory `/home/s324967/TESTING_LABS/project/cva6_assignments/verif/sim'
make[1]: Leaving directory `/home/s324967/TESTING_LABS/project/cva6_assignments/verif/sim'
