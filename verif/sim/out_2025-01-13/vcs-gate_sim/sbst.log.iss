...
make vcs_uvm_run && /opt/toolchain_riscv_13_cva6/bin/spike-dasm --isa=rv64imafdc_zicsr_zifencei < /home/s324967/TESTING_LABS/project/cva6_assignments/verif/sim/vcs_results/default/vcs.d/trace_rvfi_hart_00.dasm > /home/s324967/TESTING_LABS/project/cva6_assignments/verif/sim/out_2025-01-13/vcs-gate_sim/sbst.log
make[1]: Entering directory `/home/s324967/TESTING_LABS/project/cva6_assignments/verif/sim'
\
...
++/home/s324967/TESTING_LABS/project/cva6_assignments/verif/sim/out_2025-01-13/directed_asm_tests/sbst.o \
+elf_file=/home/s324967/TESTING_LABS/project/cva6_assignments/verif/sim/out_2025-01-13/directed_asm_tests/sbst.o \
...
*WARN* SYS INIT error: sysInit.c:374, getcwd, libc msg: No such file or directory
*ERROR* Failed on getcwd: 2
shell-init: error retrieving current directory: getcwd: cannot access parent directories: No such file or directory
shell-init: error retrieving current directory: getcwd: cannot access parent directories: No such file or directory
#0  0x00007fffe8db2b40 in __read_nocancel () from /lib64/libc.so.6
#1  0x00007fffe8d3ed54 in __GI__IO_file_underflow () from /lib64/libc.so.6
#2  0x00007fffe8d3ff22 in __GI__IO_default_uflow () from /lib64/libc.so.6
#3  0x00007fffe8d32cd4 in __GI__IO_getline_info () from /lib64/libc.so.6
#4  0x00007fffe8d31ad6 in fgets () from /lib64/libc.so.6
#5  0x00000000016d3830 in _sys_fgets ()
#6  0x00000000016a4003 in sysGetCallStack ()
#7  0x00000000016b3e93 in sysWalkStkFrame ()
#8  0x00000000016b36c9 in sysErrorVaList ()
#9  0x00000000016b3757 in sysError ()
#10 0x00000000016af8fa in sysInitInMain ()
#11 0x00000000008fc9ce in sysInit ()
#12 0x00000000008fc347 in main ()
*WARN* too many pop sysProfile
logDir = /tmp/
make[1]: Leaving directory `/home/s324967/TESTING_LABS/project/cva6_assignments/verif/sim'
/bin/sh: /home/s324967/TESTING_LABS/project/cva6_assignments/verif/sim/vcs_results/default/vcs.d/trace_rvfi_hart_00.dasm: No such file or directory
make: *** [vcs-uvm] Error 1
